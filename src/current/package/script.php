...
if (!class_exists('pkg_eclabsInstallerScript'))
{
    ...
    class pkg_eclabsInstallerScript
    {
        use pkg_eclabsInstallerScriptTrait__UNIQUE_SUFFIX__;
        ...
        private static function _renderHistory(): void
        {
            ...
            <ul class="version-history">
                <li><span class="version-upgraded">2.0.0</span> <?php echo Text::_('PKG_ECLABS_CHANGE_LOG_2_0_0'); ?>
                </li>
                <li><span class="version-upgraded">1.0.8</span> <?php echo Text::_('PKG_ECLABS_CHANGE_LOG_1_0_8'); ?>
                </li>
                <li><span class="version-upgraded">1.0.7</span> <?php echo Text::_('PKG_ECLABS_CHANGE_LOG_1_0_7'); ?>
                </li>
                <li><span class="version-upgraded">1.0.6</span> <?php echo Text::_('PKG_ECLABS_CHANGE_LOG_1_0_6'); ?>
                </li>
 ...
 */
trait pkg_eclabsInstallerScriptTrait__UNIQUE_SUFFIX__
{
    /**
     * Адаптер установщика
