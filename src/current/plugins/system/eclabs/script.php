    ...
    public function register(Container $container): void
    {
        $container->set(InstallerScriptInterface::class, new class ($container->get(AdministratorApplication::class)) implements InstallerScriptInterface {
            ...
            private function _renderHistory(): void
            {
                ...
                <ul class="version-history">
                    <li>
                        <span class="version-upgraded">2.0.1</span> <?php echo Text::_("PLG_SYSTEM_ECLABS_CHANGE_LOG_2_0_1"); ?>
                    </li>
                    <li>
            ...
            private function _checkCompatible(): bool
            {
                ...
                {
                    $app->enqueueMessage(Text::sprintf('PLG_SYSTEM_ECLABS_ERROR_COMPATIBLE_JOOMLA', $this->minimumJoomla),
                            'error');
                ...
                {
                    $app->enqueueMessage(Text::sprintf('PLG_SYSTEM_ECLABS_ERROR_COMPATIBLE_PHP', $this->minimumPhp),
                            'error');
