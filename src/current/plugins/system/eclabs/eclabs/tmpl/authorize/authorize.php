...
if (!$vars->is_free && $vars->show_auth_btn)
{
	if (ECLVersion::getJoomlaVersion() == '3'):
		?>
        <a class="btn btn-mini button btn-info hasTooltip"
           data-original-title="<?php echo Text::_("PLG_SYSTEM_ECLABS_AUTHORISATION_BTN_TOOLTIP"); ?>"
           data-eclmodal="<?php echo $modal_params; ?>">
