...
class ECLUpdateInfoStatus extends AbstractEnum
{
	 ...
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_SUCCESS = "S";

	/**
	 * Статус: ошибка, данные пользователя отсутствуют
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_ERROR_USERINFO_MISSING = "EU";

	/**
	 * Статус: расширение не найдено на сервере обновлений
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_ERROR_MISSING_EXTENSION = "EE";

	/**
	 * Статус: ошибка авторизации пользователя на сервере обновлений
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_ERROR_AUTHORIZATION = "EA";

	/**
	 * Статус: ошибка, на сервере обновлений оттсутствует версия расширения
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_ERROR_MISSING_VERSION = "EV";

	/**
	 * Статус: ошибка некорректный токен
	 * @since 1.0.0
	 */
	public const string ECLUPDATEINFO_STATUS_ERROR_MISSING_TOKEN = "ET";
