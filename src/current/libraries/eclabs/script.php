    ...
    public function register(Container $container): void
    {
        $container->set(InstallerScriptInterface::class, new class ($container->get(AdministratorApplication::class)) implements InstallerScriptInterface {
            ...
            private function _renderHistory(): void
            {
                ...
                <ul class="version-history">
                    <li>
                        <span class="version-upgraded">2.0.1</span> <?php echo Text::_("LIB_ECLABS_CHANGE_LOG_2_0_1"); ?>
                    </li>
                    <li>
                        <span class="version-upgraded">2.0.0</span> <?php echo Text::_("LIB_ECLABS_CHANGE_LOG_2_0_0"); ?>
                    </li>
                </ul>
                <?php
            }
            ...
            private function _checkCompatible(): bool
            {
                ...
                {
                    $app->enqueueMessage(Text::sprintf('LIB_ECLABS_ERROR_COMPATIBLE_JOOMLA_4', $this->minimumJoomla),
                            'error');
                ...
                {
                    $app->enqueueMessage(Text::sprintf('LIB_ECLABS_ERROR_COMPATIBLE_PHP', $this->minimumPhp),
                            'error');
